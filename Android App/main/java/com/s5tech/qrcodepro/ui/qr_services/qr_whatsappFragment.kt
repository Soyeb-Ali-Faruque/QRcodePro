 ...
 * Use the [qr_whatsappFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class qr_whatsappFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_qr_whatsapp, container, false)
        ...
        val whatsappMessageEditText: EditText = view.findViewById(R.id.whatsapp_default_message)
        ...
        // Initialize FormValidation class
        ...
        generateQRButton.setOnClickListener {
            ...
            val whatsappNumber=countryCode+phoneNumber
            defaultMessage=whatsappMessageEditText.text.toString()

            if (!formValidation.isValidPhoneNumber(countryCode, phoneNumber)) {
                ...
                val requestData = mutableMapOf(
                    ...
                    "default_message" to defaultMessage,
...
// Add "logo" key if encodedImage is not null or empty
    ...
    companion object {
         ...
         * @return A new instance of fragment qr_whatsappFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            qr_whatsappFragment().apply {
