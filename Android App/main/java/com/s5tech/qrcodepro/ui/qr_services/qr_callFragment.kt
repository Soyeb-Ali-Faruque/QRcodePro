 ...
 * Use the [qr_callFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class qr_callFragment : Fragment() {
    ...
    override fun onCreateView(
     ...
     val view=inflater.inflate(R.layout.fragment_qr_call, container, false)
        //views
        val ccp: CountryCodePicker = view.findViewById(R.id.ccp)
        val phone_number: EditText = view.findViewById(R.id.phone_number)
        ...
        generateQRButton.setOnClickListener {
            ...
            if (!formValidation.isValidPhoneNumber(countryCode, phoneNumber)) {
                ...
                phone_number.error = "Invalid phone number"
...
// Add "logo" key if encodedImage is not null or empty
    ...
    companion object {
         ...
         * @return A new instance of fragment qr_callFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            qr_callFragment().apply {
