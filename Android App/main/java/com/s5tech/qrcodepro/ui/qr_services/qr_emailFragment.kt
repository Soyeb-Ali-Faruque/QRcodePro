 ...
 * Use the [qr_emailFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class qr_emailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_qr_email, container, false)

        //views
        val emailInput: TextView = view.findViewById(R.id.emailInput)
        val subjectInput: TextView = view.findViewById(R.id.subjectInput)
        val bodyInput: TextView = view.findViewById(R.id.bodyInput)
...
// Add "logo" key if encodedImage is not null or empty
    ...
    companion object {
         ...
         * @return A new instance of fragment qr_emailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            qr_emailFragment().apply {
